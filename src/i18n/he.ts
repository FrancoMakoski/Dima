...
export const he: ProfileDict = {
  meta: {
    title: 'דמיטרי קזקוב — טיפול פסיכוסומטי אונליין בישראל',
    description:
      'דמיטרי קזקוב, מטפל מוסמך בפסיכוסומטיקה עם ניסיון של מעל 8 שנים. עבודה עם חרדה, התקפי חרדה, מתח, כאב ותסמינים גופניים שמקורם רגשי — אונליין, בעברית וברוסית. שיחת הכוונה ראשונית, ללא עלות.',
  },
  ...
  header: {
    ...
    nextAvailabilityLabel: 'המועד הקרוב לבקשה',
  },
  video: {
  ...
  about: {
    tabs: [
      ...
      },
      {
        ...
        casesTitle: 'מקרים נפוצים — אולי אתם מזהים את עצמכם כאן:',
        cases: [
          { title: 'רגשות מודחקים', text: 'אתם מחזיקים בפנים, מתאפקים, ממשיכים כרגיל — אבל בפנים מצטבר עומס רגשי שלא נעלם.' },
          { title: 'עומס רגשי ושחיקה בתוך המשפחה', text: 'במהלך היום העומס מצטבר, הסבלנות נגמרת, ואז מגיעות תגובות שאתם אחר כך מצטערים עליהן. בסוף היום נשארים אשמה, תסכול ועייפות רגשית.' },
          { title: 'חרדה חברתית', text: 'לפני או במהלך מפגשים עולה מתח, מודעות עצמית גבוהה ופחד מאיך שרואים אתכם.' },
          { title: 'דחיינות', text: 'אתם יודעים בדיוק מה צריך לעשות — אבל משהו עוצר. אתם דוחים, מתעסקים בדברים קטנים, ואז מגיעים לחץ, אשמה ותחושת פספוס.' },
          { title: 'פחד קהל / פחד להתבטא', text: 'אתם יודעים מה אתם רוצים להגיד, אבל הגוף מגיב — דופק מואץ, יובש בפה ופחד להישפט.' },
          { title: 'פחד משינויים', text: 'גם כשאתם יודעים שמשהו לא טוב לכם — קשה לזוז. הלא נודע מרגיש מאיים יותר מהמצב הקיים.' },
          { title: 'קושי להציב גבולות', text: 'אתם אומרים "כן" כשאתם רוצים להגיד "לא", ואז נשארים עם תסכול, כעס פנימי ושחיקה.' },
          { title: 'פחד מהיכרות (זוגיות)', text: 'אתם רוצים להתקרב, אבל ברגע שזה נהיה אמיתי — עולה חשש מדחייה, ואתם נסגרים או מתרחקים.' },
          { title: 'פחד לטעות / תחושת נחיתות', text: 'מחשבות כמו "אני לא מספיק טוב" או "אחרים יותר טובים ממני" עוצרות אתכם מלפעול.' },
        ],
      },
      {
        id: 'values',
  ...
  schedule: {
    ...
    tomorrowLabel: 'מחר',
    nextAvailabilityLabel: 'המועד הקרוב לבקשה',
    chooseSlotCta: 'בחרו מועד',
    reserveCta: 'לקביעת המפגש',
    bookingModalTitle: 'בקשה לקביעת מפגש',
    closeLabel: 'סגירה',
    dateLabel: 'תאריך',
    timeLabel: 'שעה',
    typeLabel: 'סוג הטיפול',
    typeValue: 'טיפול אישי',
    formatLabel: 'מסגרת',
    formatValue: 'אונליין',
    priceLabel: 'מחיר המפגש הראשון',
    confirmWhatsApp: 'אישור בוואטסאפ',
    consentTitle: 'הצהרת מטופל והסכמה לתהליך',
    consentItems: [
      'אני בן/בת 18 ומעלה.',
      'איני נוטל/ת תרופות פסיכיאטריות ואיני נמצא/ת במעקב פסיכיאטרי.',
      'ידוע לי כי במידה והמטפל ימצא לנכון, מתוך אחריות מקצועית ודאגה לטובתי, ניתן יהיה להפסיק את התהליך. במקרה כזה יוחזר הסכום ששולם.',
      'לשמירה על תיאום מיטבי, ידוע לי כי ביטול פגישה בפחות מ-24 שעות מראש, או אי-הגעה, ייחשבו כביטול מאוחר, והמקדמה תשמש כדמי ביטול.',
    ],
    consentAcceptLabel: 'אני מאשר/ת את כל התנאים',
  },
  reviews: {
  ...
  verified: {
    title: 'ניסיון והכשרה מקצועית',
    checks: [
      'תעודת האגודה הלאומית למומחים בפסיכוסומטיקה',
      'מעל 8 שנות עבודה טיפולית',
      'תעודת השתלמות מקצועית בהיקף של 120 שעות',
    ],
  },
  faq: {
    title: 'שאלות נפוצות',
    groups: [
      {
        ...
        items: [
          {
            q: 'כמה עולה מפגש?',
            a: 'המפגש הראשון עולה 197 ₪. מחיר מפגשי ההמשך משתנה לפי הצורך — לבירור מדויק כתבו לנו בוואטסאפ.',
          },
          {
        ...
        items: [
          {
            ...
            a: 'מפגשים אישיים בשיחת וידאו, עד שעה לכל מפגש. כדאי לבחור מקום שקט שבו נוח לכם לדבר.',
          },
          {
            q: 'האם זה דיסקרטי?',
          ...
          {
            q: 'כמה מפגשים צריך?',
            a: 'מספר המפגשים תלוי במצב שלכם ונקבע באופן אישי.',
          },
        ],
      },
    ],
  ...
  footer: {
    nav: {
      heading: 'ניווט',
      links: [
        { label: 'קביעת פגישה אונליין', href: '/booking' },
        { label: 'הכשרה ותעודות', href: '/credentials' },
        { label: 'תנאי שימוש ומדיניות פרטיות', href: '/terms' },
      ],
    },
  ...
  waMessages: {
    ...
    bookSlot: 'שלום, אשמח לקבוע מפגש: {slot}',
  },
  jsonLd: {
    personDescription:
